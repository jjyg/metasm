...
module C
	...
	class Compiler
		...
		def compile
			cf = @exeformat.unique_labels_cache & @auto_label_list.keys
			raise "compile_c name conflict: #{cf.inspect}" if not cf.inspect
			@exeformat.unique_labels_cache |= @auto_label_list.keys
